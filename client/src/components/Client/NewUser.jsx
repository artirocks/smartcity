      ...
      >
        ...
        >
          <div style={{ margin: "auto 0" }}>
            <h1 style={{ color: "rgb(14 21 246 / 85%)" }}></h1>
          </div>
          <div style={{ margin: "auto 0" }}>
            <Button
              type="primary"
        ...
        <Card style={{ width: "50%", margin: "0 auto" }} hoverable>
          <Form layout="horizontal" style={{ margin: "10px" }} size={"large"}>
            ...
            <Form.Item  label="Do you want to act as a Resolver also ?"
            name="sender" 
            rules={[{ required: true, message: 'Please select your role!' }]}>
          <Radio.Group onChange={(e) => {setformData({ ...formData, resolver: e.target.value })}} value={formData.resolver}>
